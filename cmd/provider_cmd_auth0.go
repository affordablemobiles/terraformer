//go:build auth0 || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdAuth0Importer)
	providerGenerators["auth0"] = newAuth0Provider
}
