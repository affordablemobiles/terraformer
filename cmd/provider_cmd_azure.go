//go:build azure || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdAzureImporter)
	providerGenerators["azure"] = newAzureProvider
}
