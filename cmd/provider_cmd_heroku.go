//go:build heroku || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdHerokuImporter)
	providerGenerators["heroku"] = newHerokuProvider
}
