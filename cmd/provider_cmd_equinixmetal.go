//go:build metal || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdEquinixMetalImporter)
	providerGenerators["metal"] = newEquinixMetalProvider
}
