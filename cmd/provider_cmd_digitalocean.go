//go:build digitalocean || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdDigitalOceanImporter)
	providerGenerators["digitalocean"] = newDigitalOceanProvider
}
