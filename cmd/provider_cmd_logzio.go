//go:build logzio || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdLogzioImporter)
	providerGenerators["logzio"] = newLogzioProvider
}
