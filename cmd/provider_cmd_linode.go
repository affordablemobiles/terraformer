//go:build linode || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdLinodeImporter)
	providerGenerators["linode"] = newLinodeProvider
}
