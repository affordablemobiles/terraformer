//go:build kubernetes || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdKubernetesImporter)
	providerGenerators["kubernetes"] = newKubernetesProvider
}
