//go:build rabbitmq || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdRabbitMQImporter)
	providerGenerators["rabbitmq"] = newRabbitMQProvider
}
