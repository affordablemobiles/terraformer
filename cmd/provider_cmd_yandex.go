//go:build yandex || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdYandexImporter)
	providerGenerators["yandex"] = newYandexProvider
}
