//go:build azuredevops || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdAzureDevOpsImporter)
	providerGenerators["azuredevops"] = newAzureDevOpsProvider
}
