//go:build honeycombio || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdHoneycombioImporter)
	providerGenerators["honeycombio"] = newHoneycombioProvider
}
