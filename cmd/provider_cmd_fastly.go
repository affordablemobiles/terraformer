//go:build fastly || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdFastlyImporter)
	providerGenerators["fastly"] = newFastlyProvider
}
