//go:build alicloud || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdAliCloudImporter)
	providerGenerators["alicloud"] = newAliCloudProvider
}
