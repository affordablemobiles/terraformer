//go:build gmailfilter || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdGmailfilterImporter)
	providerGenerators["gmailfilter"] = newGmailfilterProvider
}
