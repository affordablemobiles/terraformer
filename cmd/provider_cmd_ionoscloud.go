//go:build ionoscloud || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdIonosCloudImporter)
	providerGenerators["ionoscloud"] = newIonosCloudProvider
}
