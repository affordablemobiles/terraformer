//go:build newrelic || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdNewRelicImporter)
	providerGenerators["newrelic"] = newNewRelicProvider
}
