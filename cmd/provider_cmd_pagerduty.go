//go:build pagerduty || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdPagerDutyImporter)
	providerGenerators["pagerduty"] = newPagerDutyProvider
}
