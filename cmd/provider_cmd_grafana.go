//go:build grafana || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdGrafanaImporter)
	providerGenerators["grafana"] = newGrafanaProvider
}
