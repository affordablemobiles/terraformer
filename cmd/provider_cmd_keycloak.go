//go:build keycloak || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdKeycloakImporter)
	providerGenerators["keycloak"] = newKeycloakProvider
}
