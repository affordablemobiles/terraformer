//go:build gitlab || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdGitLabImporter)
	providerGenerators["gitlab"] = newGitLabProvider
}
