//go:build mackerel || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdMackerelImporter)
	providerGenerators["mackerel"] = newMackerelProvider
}
