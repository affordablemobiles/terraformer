//go:build github || !single_provider
...
func init() {
	providerImporterSubcommands = append(providerImporterSubcommands, newCmdGithubImporter)
	providerGenerators["github"] = newGitHubProvider
}
